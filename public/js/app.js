...
__WEBPACK_IMPORTED_MODULE_2_axios___default.a.defaults.baseURL = 'http://apidemo.local/api';
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("h1", [_vm._v("Laravel 5 – 酷炫的後台")])
}
var staticRenderFns = []
render._withStripped = true
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("h1", [_vm._v("Laravel 5 Vue SPA 認證")])
}
var staticRenderFns = []
render._withStripped = true
      ...
      ? _c(
          ...
          [
            _c(
              ...
              [
                _c("label", { attrs: { for: "name" } }, [_vm._v("帳號")]),
                _vm._v(" "),
                _c("input", {
                  directives: [
                    {
...
var render = function() {
  ...
  return _c("div", [
    _vm.error
      ? _c("div", { staticClass: "alert alert-danger" }, [
          _c("p", [_vm._v("出錯了 請檢查email/密碼是否正確")])
        ])
      : _vm._e(),
    _vm._v(" "),
    _c(
